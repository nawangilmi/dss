...
<!-- <body style="background-image:url(assets/images/mycoding.jpg);background-size:cover;"> -->
<body style="background-color:grey; border-color:black;">
    <div class="container">
        <div class="row">
                ...
                <form action="<?=$_SERVER['REQUEST_URI']?>" method="POST">
                    <div class="panel panel-dark login-box">
                        ...
                        <div class="panel-footer">
                            ...
                            <br>
                            <!-- <p class="text-center">PT. 401XD Group Indonesia</p> -->
                        </div>
                    </div>
                </form>
            </div>
